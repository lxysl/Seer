...
class StateActionNormalizer:
    ...
    def normalize_pose_action(self, pose_action):
        ...
        mean = self.action_mean[self.hand_action_dim:self.hand_action_dim+self.pose_action_dim].to(device)
        std = self.action_std[self.hand_action_dim:self.hand_action_dim+self.pose_action_dim].to(device)
        valid_mask = self.valid_action_mask[self.hand_action_dim:self.hand_action_dim+self.pose_action_dim].to(device)
    ...
    def normalize_robot_action(self, robot_action):
        ...
        mean = self.action_mean[self.hand_action_dim+self.pose_action_dim:].to(device)
        std = self.action_std[self.hand_action_dim+self.pose_action_dim:].to(device)
        valid_mask = self.valid_action_mask[self.hand_action_dim+self.pose_action_dim:].to(device)
    ...
    def normalize_pose_state(self, pose_state):
        ...
        mean = self.state_mean[self.hand_state_dim:self.hand_state_dim+self.pose_state_dim].to(device)
        std = self.state_std[self.hand_state_dim:self.hand_state_dim+self.pose_state_dim].to(device)
        valid_mask = self.valid_state_mask[self.hand_state_dim:self.hand_state_dim+self.pose_state_dim].to(device)
    ...
    def normalize_robot_state(self, robot_state):
        ...
        mean = self.state_mean[self.hand_state_dim+self.pose_state_dim:].to(device)
        std = self.state_std[self.hand_state_dim+self.pose_state_dim:].to(device)
        valid_mask = self.valid_state_mask[self.hand_state_dim+self.pose_state_dim:].to(device)
